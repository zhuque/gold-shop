<template>
  <view class="order-card">
    <view class="order-header">
      ...
      <uni-tag type="primary" :text="order.orderStatus" style="font-weight: 500;" />
    </view>
...
const handleCancelOrder = async () => {
  uni.navigateTo({
    url: `/pages/orders/cancel?orderId=${order.value.orderId}&orderTypeLabel=${order.value.typeLabel}&id=${order.value.id}`
  })
}
</script>
